...
static const lv_font_fmt_txt_cmap_t cmaps[] =
    {
        {.range_start = 44, .range_length = 133, .glyph_id_start = 1, .unicode_list = unicode_list_0, .glyph_id_ofs_list = NULL, .list_length = 14, .type = LV_FONT_FMT_TXT_CMAP_SPARSE_TINY}};
